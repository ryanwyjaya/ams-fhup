...
<div class="row">
            ...
            <div class="col-lg-5" >
                <div class="box">
                    ...
                    <strong>Laporan Buku Agenda</strong> 
                    </div>
                    ...
                    <form id="formfilter">
                        ...
                        <button onclick="prosesReset()" type="button" class="btn btn-sm btn-danger ml-2"><i class="fa fa-ban"></i> Reset</button>
            ...
            <div class="col-lg-7" id="tanggalfilter">
                <div class="box">
                    <div class="box-header">
                    <strong>Laporan Buku Agenda Filter By Tanggal</strong>
                    </div>
                    <form action="<?php echo base_url(); ?>agenda_sk/filter" method="POST" target="_blank">
            ...
            <div class="col-lg-7" id="bulanfilter">
                <div class="box">
                    <div class="box-header">
                    <strong>Laporan Buku Agenda Filter By Bulan</strong>
                    </div>
                    <form id="formbulan" action="<?php echo base_url(); ?>agenda_sk/filter" method="POST" target="_blank">
                        <div class="box-body box-block">
            ...
            <div class="col-lg-7" id="tahunfilter">
                <div class="box">
                    <div class="box-header">
                    <strong>Laporan Buku Agenda Filter By Tahun</strong>
                    </div>
                    <form id="formtahun" action="<?php echo base_url(); ?>agenda_sk/filter" method="POST" target="_blank">
                    <input name="valnilai" type="hidden">
                        <div class="box-body box-block">
