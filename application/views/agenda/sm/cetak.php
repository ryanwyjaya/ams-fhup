...
<div class="row">
            ...
            <div class="col-lg-7" id="tanggalfilter">
                <div class="box">
                    ...
                    <form action="<?php echo base_url(); ?>agenda_sm/filter" method="POST" target="_blank">
            ...
            <div class="col-lg-7" id="bulanfilter">
                <div class="box">
                    ...
                    <form id="formbulan" action="<?php echo base_url(); ?>agenda_sm/filter" method="POST" target="_blank">
                        <div class="box-body box-block">
            ...
            <div class="col-lg-7" id="tahunfilter">
                <div class="box">
                    ...
                    <form id="formtahun" action="<?php echo base_url(); ?>agenda_sm/filter" method="POST" target="_blank">
                    <input name="valnilai" type="hidden">
                        <div class="box-body box-block">
