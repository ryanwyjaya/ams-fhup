	...
	<div class="box-body">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<input type="text" class="form-control" name="no_surat" value="<?= $edit['no_surat']; ?>">
				<label style="margin-top: 10px;"><b class="text-uppercase">tujuan surat</b></label>
				<input type="text" class="form-control" name="tujuan_surat" value="<?= $edit['tujuan_surat']; ?>">
				<label style="margin-top: 10px;"><b class="text-uppercase">asal surat</b></label>
				<input type="text" class="form-control" name="asal_surat" value="<?= $edit['asal_surat']; ?>">
				<?php if (empty($edit['file'])): ?>
					<label style="margin-top: 10px;"><b>Lihat File <b class="text-danger">File Kosong</b> <a href="<?= base_url('assets/upload/').$edit['file']; ?>"><small><?= $edit['file']; ?></small></a></b></label>
				<?php else: ?>
					<label style="margin-top: 10px;"><b>Lihat File <a href="<?= base_url('assets/upload/').$edit['file']; ?>"><small><?= $edit['file']; ?></small></a></b></label>
			...
			<div class="col-sm-4">
				...
				<input type="text" class="form-control" name="perihal" value="<?= $edit['perihal']; ?>">
				<label style="margin-top: 10px;"><b class="text-uppercase">jenis surat</b></label>
				<select class="form-control" name="jenis_surat">
					<option value="<?= $edit['jenis_surat']; ?>">DEFAULT || <?= $edit['jenis_surat']; ?></option>
			...
			<div class="col-sm-4">
				...
				<input type="date" class="form-control" name="tanggal_surat" value="<?= $edit['tanggal_surat']; ?>">
				<label style="margin-top: 10px;"><b class="text-uppercase">pemohon</b></label>
				<input type="text" class="form-control" name="pemohon" value="<?= $edit['pemohon']; ?>">
				...
				<label style="margin-top: 10px;"><b class="text-uppercase">Sifat</b></label>
					 <select class="form-control" name="sifat">
					 	<option value="<?= $edit['sifat']; ?>">Default (<?= $edit['sifat']; ?>)</option>
			...
			<div class="col-sm-12" style="margin-top: 10px;" align="center">
				...
				<textarea id="ckeditor" class="ckeditor" name="isi"><?= $edit['isi']; ?></textarea>
			</div>
