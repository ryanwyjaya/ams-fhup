		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				$a = $this->db->count_all_results('surat_keluar');
				 ...
				 <input type="hidden" name="sifat" value="<?= $edit['sifat']; ?>">
				...
				<input type="text" class="form-control" name="tujuan_surat" value="<?= $edit['asal_surat']; ?>">
			...
			<div class="col-sm-4">
				...
				<input type="text" class="form-control" name="jenis_surat" value="Balasan" readonly>
			...
			<div class="col-sm-4">
				...
				<input type="text" class="form-control" name="pemohon" value="<?= $edit['nama_pengirim']; ?>">
				<label style="margin-top: 10px;"><b class="text-uppercase">alamat pemohon</b></label>
				<input type="text" class="form-control" name="alamat" value="<?= $edit['alamat_pengirim']; ?>">
			</div>
			...
			<div class="col-sm-12" style="margin-top: 30px;">
				<a class="btn btn-danger" href="<?= base_url('disposisi'); ?>"><strong class="text-white"><i class="fa fa-arrow-left text-white"></i> Kembali</strong></a>
