<div class="box">
	...
	<h3 align="center"><b class="text-primary">Arsip Digital <?= $title; ?></b></h3>
	 <?php if (validation_errors()) : ?>
            ...
            <form action="<?= base_url('surat_keluar/ad'); ?>" method="post">
...
<div class="box-group">
    ...
    <div class="box-body">
    	...
    	<p class="box-text text-center"><small class="text-muted">TUJUAN SURAT <b class="text-success"><br><?= $value['tujuan_surat']; ?></b> </small></p>
